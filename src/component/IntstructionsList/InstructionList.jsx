...
function InstructionsList({ instructions}) {
  ...
  return (
    <div className="instructions-container" data-testid="instructions-container">
      <h2 className="instructions-title" aria-label="Cooking Instructions">Cooking Instructions</h2>
