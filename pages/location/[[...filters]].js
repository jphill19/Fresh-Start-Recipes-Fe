      ...
      <div className="max-w-md mx-auto">
        ...
        {isLoading ? (
          <div className="flex justify-center items-center h-[200px]">
            <ClipLoader color="green" size={50} loading={isLoading} />
          </div>
        ) : (
          <>
            {/* Map Container */}
            <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm w-full mb-4">
              <Map
                locations={locations}
            ...
            <div className="max-h-[400px] overflow-y-auto w-full border border-gray-200 bg-white rounded-lg p-4 shadow-sm">
              {locations.length > 0 ? (
