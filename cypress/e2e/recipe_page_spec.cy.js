describe('Recipe Page', () => {
  ...
  it.skip('tests the user interactions on the recipe page', () => {
    ...
    .get('.ingredients-container > .total-price').should('contain', '$6.00')
    .get('.ingredients-container > :nth-child(4) > .ingredient-button').click()
    ...
    .get('.list-container-open > .list-inner > :nth-child(1) > p').should('contain', 'Step 1: Wash the dirt off the potato')
    .get('.list-container-open > .list-inner > :nth-child(2) > p').should('contain', 'Step 2: Poke holes in the potato to allow steam to escape')
    .get('.list-container-open > .list-inner > :nth-child(3) > p').should('contain', 'Step 3: Put on plate in microwave and cook for 8 minutes')
    .get('.list-container-open > .list-inner > :nth-child(4) > p').should('contain', 'Step 4: If a fork is easily pushed in, its done, otherwise cook for an additional 2 minutes')
    .get('.app > :nth-child(7) > button').click()
    .get('.app > :nth-child(8) > button').click()
    .get('.list-container-open > .list-inner > :nth-child(1) > p').should('contain', 'Step 1: Preheat oven to 400 degrees')
    .get('.list-container-open > .list-inner > :nth-child(2) > p').should('contain', 'Step 2: Wash the dirt off the potato')
    .get('.list-container-open > .list-inner > :nth-child(3) > p').should('contain', 'Step 3: Poke holes in the potato to allow steam to escape')
    .get('.list-container-open > .list-inner > :nth-child(4) > p').should('contain', 'Step 4: Place potato on oven safe tray and cook for 45 minutes')
